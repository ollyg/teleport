...
func (Operation) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_auth_72a0a1a8c3b4741b, []int{0}
}
...
func (*Watch) Descriptor() ([]byte, []int) {
	return fileDescriptor_auth_72a0a1a8c3b4741b, []int{1}
}
...
func (*WatchKind) Descriptor() ([]byte, []int) {
	return fileDescriptor_auth_72a0a1a8c3b4741b, []int{2}
}
...
func (*Certs) Descriptor() ([]byte, []int) {
	return fileDescriptor_auth_72a0a1a8c3b4741b, []int{3}
}
...
type UserCertsRequest struct {
	...
	// RoleRequests is an optional list of request IDs indicating requests whose
	// escalated privileges should be added to the certificate.
	RoleRequests         []string `protobuf:"bytes,6,rep,name=RoleRequests" json:"role_requests,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (*UserCertsRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_auth_72a0a1a8c3b4741b, []int{4}
}
...
func (*GetUserRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_auth_72a0a1a8c3b4741b, []int{5}
}
...
func (*GetUsersRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_auth_72a0a1a8c3b4741b, []int{6}
}
...
// RoleRequests is a collection of RoleRequest values.
type RoleRequests struct {
	RoleRequests         []*services.RoleRequestV1 `protobuf:"bytes,1,rep,name=RoleRequests" json:"role_requests"`
	XXX_NoUnkeyedLiteral struct{}                  `json:"-"`
	XXX_unrecognized     []byte                    `json:"-"`
	XXX_sizecache        int32                     `json:"-"`
}

func (m *RoleRequests) Reset()         { *m = RoleRequests{} }
func (m *RoleRequests) String() string { return proto.CompactTextString(m) }
func (*RoleRequests) ProtoMessage()    {}
func (*RoleRequests) Descriptor() ([]byte, []int) {
	return fileDescriptor_auth_72a0a1a8c3b4741b, []int{7}
}
func (m *RoleRequests) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *RoleRequests) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_RoleRequests.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalTo(b)
		if err != nil {
...
func (dst *RoleRequests) XXX_Merge(src proto.Message) {
	xxx_messageInfo_RoleRequests.Merge(dst, src)
}
func (m *RoleRequests) XXX_Size() int {
	return m.Size()
}
func (m *RoleRequests) XXX_DiscardUnknown() {
	xxx_messageInfo_RoleRequests.DiscardUnknown(m)
}

var xxx_messageInfo_RoleRequests proto.InternalMessageInfo

func (m *RoleRequests) GetRoleRequests() []*services.RoleRequestV1 {
	if m != nil {
		return m.RoleRequests
	}
	return nil
...
func (*RequestStateSetter) Descriptor() ([]byte, []int) {
	return fileDescriptor_auth_72a0a1a8c3b4741b, []int{8}
}
...
// RequestID is the unique identifier of a role request.
...
func (*RequestID) Descriptor() ([]byte, []int) {
	return fileDescriptor_auth_72a0a1a8c3b4741b, []int{9}
}
...
func init() {
	...
	proto.RegisterType((*RoleRequests)(nil), "proto.RoleRequests")
...
type AuthServiceClient interface {
	...
	// GetRoleRequests gets all pending role requests.
	GetRoleRequests(ctx context.Context, in *services.RoleRequestFilter, opts ...grpc.CallOption) (*RoleRequests, error)
	// WatchRoleRequests is a variant of WatchEvents which supports custom
	// filtering options specific to role requests.
	WatchRoleRequests(ctx context.Context, in *services.RoleRequestFilter, opts ...grpc.CallOption) (AuthService_WatchRoleRequestsClient, error)
	// CreateRoleRequest creates a new role request.
	CreateRoleRequest(ctx context.Context, in *services.RoleRequestV1, opts ...grpc.CallOption) (*empty.Empty, error)
	// DeleteRoleRequest deletes a role request.
	DeleteRoleRequest(ctx context.Context, in *RequestID, opts ...grpc.CallOption) (*empty.Empty, error)
	// SetRoleRequestState sets the state of a role request.
	SetRoleRequestState(ctx context.Context, in *RequestStateSetter, opts ...grpc.CallOption) (*empty.Empty, error)
}
...
func (c *authServiceClient) GetRoleRequests(ctx context.Context, in *services.RoleRequestFilter, opts ...grpc.CallOption) (*RoleRequests, error) {
	out := new(RoleRequests)
	err := c.cc.Invoke(ctx, "/proto.AuthService/GetRoleRequests", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *authServiceClient) WatchRoleRequests(ctx context.Context, in *services.RoleRequestFilter, opts ...grpc.CallOption) (AuthService_WatchRoleRequestsClient, error) {
	stream, err := c.cc.NewStream(ctx, &_AuthService_serviceDesc.Streams[3], "/proto.AuthService/WatchRoleRequests", opts...)
	if err != nil {
		return nil, err
	}
	x := &authServiceWatchRoleRequestsClient{stream}
	if err := x.ClientStream.SendMsg(in); err != nil {
		return nil, err
	}
	if err := x.ClientStream.CloseSend(); err != nil {
...
type AuthService_WatchRoleRequestsClient interface {
	Recv() (*services.RoleRequestV1, error)
	grpc.ClientStream
}

type authServiceWatchRoleRequestsClient struct {
	grpc.ClientStream
}

func (x *authServiceWatchRoleRequestsClient) Recv() (*services.RoleRequestV1, error) {
	m := new(services.RoleRequestV1)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
	return m, nil
...
func (c *authServiceClient) CreateRoleRequest(ctx context.Context, in *services.RoleRequestV1, opts ...grpc.CallOption) (*empty.Empty, error) {
	out := new(empty.Empty)
	err := c.cc.Invoke(ctx, "/proto.AuthService/CreateRoleRequest", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *authServiceClient) DeleteRoleRequest(ctx context.Context, in *RequestID, opts ...grpc.CallOption) (*empty.Empty, error) {
	out := new(empty.Empty)
	err := c.cc.Invoke(ctx, "/proto.AuthService/DeleteRoleRequest", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *authServiceClient) SetRoleRequestState(ctx context.Context, in *RequestStateSetter, opts ...grpc.CallOption) (*empty.Empty, error) {
	out := new(empty.Empty)
	err := c.cc.Invoke(ctx, "/proto.AuthService/SetRoleRequestState", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type AuthServiceServer interface {
	...
	// GetRoleRequests gets all pending role requests.
	GetRoleRequests(context.Context, *services.RoleRequestFilter) (*RoleRequests, error)
	// WatchRoleRequests is a variant of WatchEvents which supports custom
	// filtering options specific to role requests.
	WatchRoleRequests(*services.RoleRequestFilter, AuthService_WatchRoleRequestsServer) error
	// CreateRoleRequest creates a new role request.
	CreateRoleRequest(context.Context, *services.RoleRequestV1) (*empty.Empty, error)
	// DeleteRoleRequest deletes a role request.
	DeleteRoleRequest(context.Context, *RequestID) (*empty.Empty, error)
	// SetRoleRequestState sets the state of a role request.
	SetRoleRequestState(context.Context, *RequestStateSetter) (*empty.Empty, error)
}
...
func _AuthService_GetRoleRequests_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(services.RoleRequestFilter)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AuthServiceServer).GetRoleRequests(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/proto.AuthService/GetRoleRequests",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthServiceServer).GetRoleRequests(ctx, req.(*services.RoleRequestFilter))
	}
	return interceptor(ctx, in, info, handler)
}

func _AuthService_WatchRoleRequests_Handler(srv interface{}, stream grpc.ServerStream) error {
	m := new(services.RoleRequestFilter)
	if err := stream.RecvMsg(m); err != nil {
		return err
	}
	return srv.(AuthServiceServer).WatchRoleRequests(m, &authServiceWatchRoleRequestsServer{stream})
}

type AuthService_WatchRoleRequestsServer interface {
	Send(*services.RoleRequestV1) error
	grpc.ServerStream
}

type authServiceWatchRoleRequestsServer struct {
	grpc.ServerStream
}

func (x *authServiceWatchRoleRequestsServer) Send(m *services.RoleRequestV1) error {
	return x.ServerStream.SendMsg(m)
}

func _AuthService_CreateRoleRequest_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(services.RoleRequestV1)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AuthServiceServer).CreateRoleRequest(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/proto.AuthService/CreateRoleRequest",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthServiceServer).CreateRoleRequest(ctx, req.(*services.RoleRequestV1))
	}
	return interceptor(ctx, in, info, handler)
}

func _AuthService_DeleteRoleRequest_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(RequestID)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AuthServiceServer).DeleteRoleRequest(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/proto.AuthService/DeleteRoleRequest",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthServiceServer).DeleteRoleRequest(ctx, req.(*RequestID))
	}
	return interceptor(ctx, in, info, handler)
}

func _AuthService_SetRoleRequestState_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(RequestStateSetter)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AuthServiceServer).SetRoleRequestState(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/proto.AuthService/SetRoleRequestState",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthServiceServer).SetRoleRequestState(ctx, req.(*RequestStateSetter))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _AuthService_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GetRoleRequests",
			Handler:    _AuthService_GetRoleRequests_Handler,
		},
		{
			MethodName: "CreateRoleRequest",
			Handler:    _AuthService_CreateRoleRequest_Handler,
		},
		{
			MethodName: "DeleteRoleRequest",
			Handler:    _AuthService_DeleteRoleRequest_Handler,
		},
		{
			MethodName: "SetRoleRequestState",
			Handler:    _AuthService_SetRoleRequestState_Handler,
		},
	},
	Streams: []grpc.StreamDesc{
		...
		{
			StreamName:    "WatchRoleRequests",
			Handler:       _AuthService_WatchRoleRequests_Handler,
			ServerStreams: true,
		},
	},
	Metadata: "auth.proto",
...
func (m *RoleRequests) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *RoleRequests) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
	if len(m.RoleRequests) > 0 {
		for _, msg := range m.RoleRequests {
			dAtA[i] = 0xa
			i++
			i = encodeVarintAuth(dAtA, i, uint64(msg.Size()))
			n, err := msg.MarshalTo(dAtA[i:])
...
func (m *RoleRequests) Size() (n int) {
	var l int
	_ = l
	if len(m.RoleRequests) > 0 {
		for _, e := range m.RoleRequests {
			l = e.Size()
			n += 1 + l + sovAuth(uint64(l))
		}
	}
...
func (m *RoleRequests) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: RoleRequests: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: RoleRequests: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
			...
			m.RoleRequests = append(m.RoleRequests, &services.RoleRequestV1{})
			if err := m.RoleRequests[len(m.RoleRequests)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func init() { proto.RegisterFile("auth.proto", fileDescriptor_auth_72a0a1a8c3b4741b) }

var fileDescriptor_auth_72a0a1a8c3b4741b = []byte{
	...
	,
}
